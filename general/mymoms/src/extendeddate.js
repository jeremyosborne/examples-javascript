(function(){
     ...
     * 
     * NOTE: Depending on the underlying time (hours, minutes, seconds) of the
     * date, on a daylight savings boundary the day value might increment
     ...
     * 
     * NOTE: Depending on the underlying time (hours, minutes, seconds) of the
     * date, on a daylight savings boundary the day value might decrement
     * 2 days instead of one.
     * 
     * @name dayDecrement
     * @methodOf ExtendedDate
